...
module.exports = function(app) {
  ...
  app.use((req,res,next)=>{
    const origins = ["holger-velisky.github.io","kahoot.it","play.kahoot.it","create.kahoot.it","code.org","studio.code.org","kahoot-win.com","tooooooo-fast.herokuapp.com","kashoot-this.herokuapp.com","kahoot-win.herokuapp.com","lolaskoaks.herokuapp.com/"];
